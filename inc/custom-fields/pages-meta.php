...
function crb_page_theme_options() {
  ...
  Container::make( 'post_meta', 'More' )
    ...
    ->add_fields( array(
      ...
      Field::make( 'text', 'crb_main_questions_description', 'Текст для блока ОСТАЛИСЬ ВОПРОСЫ (лимит 35 символов)' )->set_attribute('maxLength', 35),
  ...
  Container::make( 'post_meta', 'More' )
    ...
    ->add_fields( array(
      ...
      Field::make( 'text', 'crb_drink_questions_description', 'Текст для блока ОСТАЛИСЬ ВОПРОСЫ (лимит 35 символов)' )->set_attribute('maxLength', 35),
